...
// Service - the struct for the comments service.
type Service struct {
	DB *gorm.DB
}
...
// GetComment - retrieves comments from the DB, by the ID.
...
// GetCommentsBySlug - retrives all comments by slug and path.
